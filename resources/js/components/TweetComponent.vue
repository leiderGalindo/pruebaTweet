                    ...
                    <form @submit.prevent="UpdateTweet(tweet)">
                        <div class="row w-100">
                            ...
                            <div class="form-group col-2">
                                ...
                                <button class="btn btn-danger mt-3" type="submit" @click="cancelarEdicion()">
...
export default {
    ...
    methods:{
        ...
        UpdateTweet(publication){
            const params = {content: publication.content};

            axios.put(`/Tweet/${publication.id}`, params)
                .then(res => {
                    const index = this.tweets.findIndex(itemBuscar => publication.id === res.data.id);
